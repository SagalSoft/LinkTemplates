...
get "/templates/view/@id", forward: "/views/template/viewTemplate.groovy?id=@id"
...
get "/blob/upload", forward: "/views/template/uploadimage.groovy"
...
post "/email", forward: "/views/template/sendMail.groovy"
get "/email", forward: "/views/template/buildmail.groovy"